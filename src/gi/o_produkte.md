...
Система способна обнаруживать более 60-и типов уязвимостей и производить проверку на соответствие регуляторным и индустриальным требованиям информационной безопасности: PCI DSS 4.0, OWASP Mobile Top-10 (2016), OWASP MASVS, PCI Software Security Framework, ОУД4, ГОСТ-57580, а также позволяет создавать свои внутренние стандарты безопасности.
...
Стингрей позволяет обнаруживать более 60-и типов уязвимостей, технология базируется на наблюдении за поведением приложения на устройстве во время различных режимов сканирования.
